...
const Papers = () => {
  ...
  const papers = [
    ...
    },
    {
      ...
      abstract: 'TTeam Black Pearl develops an underwater autonomous vehicle named “Dubojan” for Robosub 2026. The focus of our team is to develop a new lightweight AUV with the ability to perform all the tasks and also leave some room for future modification also. The work is divided into four sub teams: Mechanical and Design Team, Electronics Team, Software Team, Media and Outreach Team. Our focus is to gather experience and to do as many tasks as possible.',
