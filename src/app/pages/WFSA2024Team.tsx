...
// Hero image
import teamHeroImage from "../../assets/cc8675260403d7df8b44765508975551d10d08d7.png";
...
import imonPrantoImage from "../../assets/927f8253f0d5d0f4e48427fdef8ece793bccb74c.png";
import minhazulIslamImage from "../../assets/1ea16f6649a2805d880942c76e151af6526d08b5.png";
import syedSiddiqueImage from "../../assets/a5b70de304fa4ae28cf0fe56a3135a960c645cf8.png";
import samiunSheamImage from "../../assets/d03ec052d373863909fdf9f176e88ce8f3d8090b.png";
...
const WFSA2024Team = () => {
  ...
  const teamMembers = [
    ...
    {
      name: "Imon Ghosh Pranto",
      role: "Propulsion Specialist",
      department: "Naval Architecture & Marine Engineering",
      image: imonPrantoImage,
      email: "mailto:imon.pranto@buet.ac.bd",
      linkedin: "https://linkedin.com/in/imon-pranto",
    },
    {
      name: "Minhazul Islam",
      role: "Hull Design",
      department: "Naval Architecture & Marine Engineering",
      image: minhazulIslamImage,
      email: "mailto:minhazul.islam@buet.ac.bd",
      linkedin: "https://linkedin.com/in/minhazul-islam",
    },
    {
      name: "Syed Siddique",
      role: "Safety Systems",
      department: "Naval Architecture & Marine Engineering",
      image: syedSiddiqueImage,
      email: "mailto:syed.siddique@buet.ac.bd",
      linkedin: "https://linkedin.com/in/syed-siddique",
    },
    {
      name: "Samiun Muntasir Sheam",
      role: "Energy Systems",
      department: "Naval Architecture & Marine Engineering",
      image: samiunSheamImage,
      email: "mailto:samiun.sheam@buet.ac.bd",
      linkedin: "https://linkedin.com/in/samiun-sheam",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 -mt-20">
      ...
      <section className="relative h-[100vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          >
            WFSA 2024 <span className="text-red-500">Team</span>
          </motion.h1>
          ...
          >
            Meet the brilliant minds behind our 2nd place achievement
          </motion.p>
